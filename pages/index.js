    ...
    <div className="flex justify-center sm:px-4 p-12">
      <div className="w-full minmd:w-4/5">
        <Banner
          ...
          parentStyles="justify-start mb-6 h-72 sm:h-60 p-12 xs:p-4 xs:h-44 rounded-3xl text-white"
        />
          ...
          <>
            <div>
              ...
              <div className="relative flex-1 max-w-full flex mt-3" ref={parentRef}>
                ...
                <CreatorCard
                  ...
                  creatorEths={(10 - i * 0.32).toFixed(2)}
                />
              ))} */}
                  {!hideButtons && (
                  <>
            ...
            <div className="mt-10">
              <div className="flexBetween mx-4 xs:mx-0 minlg:mx-8 sm:flex-col sm:items-start">
                <h1 className="flex-1 first:before:font-poppins dark:text-white text-nft-black-1 text-2xl minlg:text-4xl font-semibold sm:mb-4">Top NFTs</h1>

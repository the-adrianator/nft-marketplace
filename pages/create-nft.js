          ...
          <div className="mt-4">
            <div {...getRootProps()} className={fileStyle}>
              ...
              <div className="flexCenter flex-col text-center">
                <p className="font-poppins dark:text-white text-nft-black-1 font-semibold text-lg">JPG, PNG, GIF, SVG, WEBM. Max 100mb</p>

                <div className="my-12 w-full flex-center justify-center">
                  <Image
                    src={images.upload}
                    width={100}
                    height={100}
